              ...
              <React.Fragment>
                <div style={tooltipStyles.container as CSSProperties}>
                  <div style={tooltipStyles.rows as CSSProperties}>
                    <p>Total:</p>
                    <p>{data.total_deaths}</p>
                  </div>
                  <div style={tooltipStyles.rows as CSSProperties}>
                    <p>Pneumonia, influenza, or Covid-19:</p>
                    <p>{data.pneumonia_influenza_or_covid}</p>
                  </div>
                  <div style={tooltipStyles.rows as CSSProperties}>
                    <p>Covid-19:</p>
                    <p>{data.covid_19_deaths}</p>
                  </div>
                  <div style={tooltipStyles.rows as CSSProperties}>
                    <p>Pneumonia:</p>
                    <p>{data.pneumonia_deaths}</p>
                  </div>
                  <div style={tooltipStyles.rows as CSSProperties}>
                    <p>Pneumonia and Covid-19:</p>
                    <p>{data.pneumonia_and_covid_19_deaths}</p>
                  </div>
                  <div style={tooltipStyles.rows as CSSProperties}>
                    <p>Influenza:</p>
                    <p>{data.influenza_deaths}</p>
                  </div>
                </div>
              </React.Fragment>
            }
